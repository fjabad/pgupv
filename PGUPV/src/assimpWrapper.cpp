...
class AssimpWrapper::AssimpWrapperImpl {
public:
	AssimpWrapperImpl() :
		scene(nullptr) {
	}
	std::shared_ptr<Scene> load(const string& filename, LoadOptions options);
...
AssimpWrapper::AssimpWrapper() :
	impl(std::make_unique<AssimpWrapperImpl>()) {
}
...
std::shared_ptr<Scene> AssimpWrapper::load(const std::string& filename, LoadOptions options)
{
	return impl->load(filename, options);
}

std::vector<PGUPV::ExportFileFormat> AssimpWrapper::listSupportedExportFormat()
{
	return impl->listSupportedExportFormat();

}

bool AssimpWrapper::save(const std::string& path, const std::string& id, std::shared_ptr<Scene> scene)
{
	return impl->save(path, id, scene);
}


std::shared_ptr<Scene> AssimpWrapper::AssimpWrapperImpl::load(const string& filename, LoadOptions options)
{
...
Assimp::Exporter& AssimpWrapper::AssimpWrapperImpl::getExporter() {
	if (!exporter) {
...
std::vector<PGUPV::ExportFileFormat> AssimpWrapper::AssimpWrapperImpl::listSupportedExportFormat()
{
...
std::shared_ptr<Node> AssimpWrapper::AssimpWrapperImpl::recursive_load(const struct aiNode* nd) {
...
void AssimpWrapper::AssimpWrapperImpl::loadMeshes() {
...
std::shared_ptr<Skeleton> AssimpWrapper::AssimpWrapperImpl::buildSkeleton(const struct aiMesh* mesh)
{
...
void AssimpWrapper::AssimpWrapperImpl::loadTextures(const aiMaterial* aimat, Material& pgmat) {
...
void AssimpWrapper::AssimpWrapperImpl::loadPBRTextures(const aiMaterial* aimat, PBRMaterial& pgmat)
{
...
void AssimpWrapper::AssimpWrapperImpl::loadMaterials() {
...
void AssimpWrapper::AssimpWrapperImpl::loadAnimations() {
...
bool AssimpWrapper::AssimpWrapperImpl::save(const std::string& path, const std::string& id, std::shared_ptr<Scene> pgscene) {
