...
namespace PGUPV {
	...
	void buildConstantColorUniformMVP(PGUPV::Program& program);
	...
	*/
	...
	Igual que ConstantIllumProgram, pero especificando directamente la matriz de transformación

	ConstantIllumProgramMVP::use();

	glm::mat4 mvp;
	[...]
	ConstantIllumProgramMVP::setMVP(mvp);
	...
	*/
	...
	public:
		...
		*/
		static Program* use();
		/**
		Establece la matriz de transformación model-view-projection a usar
	...
	*/
	...
	Igual que ConstantUniformColorProgram, pero especificando directamente la matriz de
	transformación, en vez de GLMatrices.

	glm::mat4 mvp;
	[...]
	ConstantUniformColorProgramMVP::use();
	ConstantUniformColorProgramMVP::setMVP(mvp);
	ConstantUniformColorProgram::setColor(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f));
